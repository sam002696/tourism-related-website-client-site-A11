        ...
        <div>
            <div className='bg-gray-100 lg:flex lg:flex-row justify-evenly m-12 p-10 rounded-3xl sm:flex-col-reverse sm:flex sm:m-5'>
                ...
                <div className='flex-col self-center sm:pt-1.5 sm:w-11/12 w-1/3'>
                    <h1 className='font-bold text-5xl'>Your <span className='hover:text-green-600 text-blue-600'>Hotel, car</span> and experiences</h1>
                    <p className='mt-10 text-2xl'>Accompanying us, you have a trip full of experiences. With Chisfis, booking accommodation, resort villas, hotels.</p>
            ...
            <div>
                <h1 className='font-bold p-10 text-5xl text-center'>Choose Your Package <span className='text-green-600'></span></h1>
            </div>
            <div>
                <h1 className="mx-auto sm:text-2xl text-3xl text-center w-2/3">Select Your Best Package For Your Travel</h1>
            </div>
            ...
            {/* How it work */}
            <div>
                <h1 className='font-bold p-10 text-5xl text-center'>How it work <span className='text-green-600'></span></h1>
            </div>
            <div>
                <h1 className="mx-auto sm:text-2xl text-3xl text-center w-2/3">Keep calm and travel on</h1>
            </div>
            ...
            <div>
                <h1 className='font-bold p-10 text-5xl text-center'>Suggestions for discovery <span className='text-green-600'></span></h1>
            </div>
            <div>
                <h1 className="mx-auto sm:text-2xl text-3xl text-center w-2/3">Popular places to stay that Chisfis recommends for you</h1>
            </div>
